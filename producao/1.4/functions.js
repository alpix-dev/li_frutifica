...
//let ENV_ = "http://127.0.0.1:5500/";
let ENV_ = "https://cdn.jsdelivr.net/gh/alpix-dev/li_frutifica/";
...
theme.build.header = function(template){
    ...
    $('#theme_header-functions').prepend('<li><button type="button" class="account-trigger">'+ theme.icon.account +'<div><b>Olá, <span data-username>'+ theme.userFirstname+ '</span></b>'+ (theme.userFirstname == "Visitante" ? 'Faça login ou cadastre-se' : 'Minha Conta')+'</div></button></li>');
        ...
        $('#f_entrega-modal form').submit(function(e){
            ...
            $.get('/carrinho/frete?cep='+ apx_zip +'&produto_id=130135051&quantidade=1', function(data, status){
                ...
                if(dt.length > 0){
                    ...
                    $('#f_entrega-modal-result').html('<span class="err" style="font-size:13px">Pedimos desculpas, mas no momento ainda não realizamos entregas na sua região. Estamos empenhados em expandir nossa cobertura e em breve estaremos levando todo o nosso sabor até a sua casa. Enquanto isso, você pode entrar em contato conosco através do nosso WhatsApp para agendar a retirada dos seus pedidos em nossa loja física.</span>');
                }
...
theme.build.footer = function(template){
    ...
    //$('#rodape .institucional').html('<div class="bg-gray"> <div class="conteiner"> <div class="row-fluid"> <div class="span4"> <div theme-content="logo"></div><div theme-content="store-description"></div><div theme-content="social"></div></div><div class="span8"> <div class="row-flex justify-content-between"> <div class="col-auto"> <h4>Institucional</h4> <div theme-content="pages"></div></div><div class="col-auto"> <h4>Pratos</h4> <div theme-content="categories-1"></div></div><div class="col-auto"> <h4>Kits</h4> <div theme-content="categories-2"></div></div></div></div></div></div></div><div class="bg-lime_green"> <div class="conteiner"> <div class="row-fluid"> <div class="span12"> <div theme-content="newsletter"></div></div></div></div></div></div><div class="bg-gray"> <div class="conteiner"> <div class="row-flex"> <div class="col"> <h4>Formas de Pagamento</h4> <div id="forma_pagamento_bandeiras" style=""><div class="box um"><div class="titulo_bandeira"><span>Bandeiras</span></div><div class="bandeiras" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/american.png" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/aura.png" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/dinersclub.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/elo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/hipercard.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/mastercard.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/visa.png"></div><div class="bandeiras pix"><img src="https://cdn.awsli.com.br/568/568718/arquivos/pix.png"></div></div><div class="box dois"><div class="titulo_bandeira"><span>Vale-Alimentação/Refeição</span></div><div class="bandeiras"><img src="https://cdn.awsli.com.br/568/568718/arquivos/vr.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/ticket.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/pluxee.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/alelo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/cabal.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/ben.png"><img style="width: 55px;" src="https://cdn.awsli.com.br/568/568718/arquivos/verocard-logo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/up.png"></div></div><div class="box tres"><div class="titulo_bandeira"><span>Link de Pagamento</span></div><div class="bandeiras"><img src="https://cdn.awsli.com.br/568/568718/arquivos/ifood.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/caju.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/flash.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/swile.png"></div></div></div></div><div class="col"> <h4>Selos e Segurança</h4> <div theme-content="seals"></div></div></div></div></div>');
    
    $('#rodape .institucional').html('<div class="bg-gray"><div class="conteiner"><div class="row-fluid"><div class="span4"><div theme-content="logo"></div><div theme-content="store-description"></div><div theme-content="social"></div></div><div class="span8"><div class="row-flex justify-content-between"><div class="col-auto"><h4>Institucional</h4><div theme-content="pages"></div></div><div class="col-auto"><h4>Pratos</h4><div theme-content="categories-1"></div></div><div class="col-auto"><h4>Kits</h4><div theme-content="categories-2"></div></div></div></div></div></div></div><div class="bg-lime_green"><div class="conteiner"><div class="row-fluid"><div class="span12"><div theme-content="newsletter"></div></div></div></div></div></div><div class="bg-gray"><div class="conteiner"><div class="row-flex"><div class="col"><h4>Formas de Pagamento</h4><div id="forma_pagamento_bandeiras" style=""><div class="box um"><div class="titulo_bandeira"><span>Bandeiras</span></div><div class="bandeiras" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/american.png" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/aura.png" style=""><img src="https://cdn.awsli.com.br/568/568718/arquivos/dinersclub.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/elo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/hipercard.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/mastercard.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/visa.png"></div><div class="bandeiras pix"><img src="https://cdn.awsli.com.br/568/568718/arquivos/pix.png"></div></div><div class="box dois"><div class="titulo_bandeira"><span>Vale-Alimentação/Refeição</span></div><div class="bandeiras"><img src="https://cdn.awsli.com.br/568/568718/arquivos/vr.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/ticket.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/pluxee.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/alelo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/cabal.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/ben.png"><img style="width: 55px;" src="https://cdn.awsli.com.br/568/568718/arquivos/verocard-logo.png"><img src="https://cdn.awsli.com.br/568/568718/arquivos/up.png"><img style="width: 40px;" src="https://cdn.awsli.com.br/568/568718/arquivos/caju.png"></div></div></div></div><div class="col"><h4>Selos e Segurança</h4><div theme-content="seals"></div></div></div></div></div>');
    ...
    $('[theme-content="categories-1"]').html('<ul>' + $('#f_header .categoria-id-5162392').first().find('ul.nivel-dois').html() + '</ul>');
    $('[theme-content="categories-2"]').html('<ul>' + $('#f_header .categoria-id-5162708').first().find('ul.nivel-dois').html() + '</ul>');
...
theme.build.productFilter = function(template){
    ...
    let et = urlParams.get('et');
    $(window).load(function(){
        if(et){
            $('[data-filter="'+ et +'"]').closest('li').addClass('filtered');
            $('[data-produtos-linha] > li:not(.filtered)').remove();

            $('.product__count').text($('.filtered').length)
            //alert(et)
        }
    })
    //if($('.coluna .filtro-coluna').length > 0){
        ...
        if($('h1').text().trim() == "Pratos"){
            $('#theme_filter').append('<h4>Etiquetas</h4><div><ul id="filter_db_etiquetas"></ul></div>');
            
            let db_etiquetas = sessionStorage.getItem('db_etiquetas')
            db_etiquetas = db_etiquetas ? JSON.parse(db_etiquetas) : db_etiquetas;
            if(db_etiquetas){
                $.each(db_etiquetas, function(k_,i_){
                    $('#filter_db_etiquetas').append(`<li class="${et && et.includes(i_.id) ? 'active' : ''}"><a href="${'?et=' + i_.id}">${i_.titulo}</a></li>`)
                })
            }
        }
    //}
...
// theme.formas_pag_entrega = ['Cartao-de-Debito','Cartao-de-Credito','Ticket','VR-Ben','VR-Alelo','VR-Sodexo','VA-Sodexo', 'VR-Caju', 'Link-de-Pagamento:VR-Flash', 'Link-de-Pagamento:VR-IFood', 'Link-de-Pagamento:VA-IFood', 'VA-Caju', 'UP-Beneficios', 'VR-Verocard', 'VA-Verocard'];
theme.formas_pag_entrega = ['Cartao-de-Debito','Cartao-de-Credito','Ticket','VR-Ben','VR-Alelo','VR-Sodexo','VA-Sodexo', 'VR-Caju', 'VA-Caju', 'UP-Beneficios', 'VR-Verocard', 'VA-Verocard'];
...
theme.comoFunciona.subtitle = "Descubra na Frutifica marmitas ultracongeladas práticas e saborosas. Com ingredientes frescos e selecionados, oferecemos refeições de qualidade para facilitar seu dia a dia. Experimente a comodidade de receber nossas marmitas em casa e desfrute de uma alimentação descomplicada e deliciosa.";
theme.comoFunciona.itens = [];
theme.comoFunciona.itens.push({
    img : ENV_ + 'F-0-260X260.jpg',
...
theme.functions.datepicker = function(){
    ...
    $('#formularioObservacoes_2').closest('.row-fluid').before('<div class="row-fluid extra-fields"><label>Caso esteja ausente, podemos deixar na portaria?</label><div class="controls"><select required><option value="Sim" selected>Sim</option><option value="Não">Não</option></select></div></div>');
    //$('#formularioObservacoes_2').closest('.row-fluid').before('<div class="row-fluid extra-fields"><label>Os produtos deverão ser entregues congelados?</label><div class="controls"><select required><option>Selecione...</option><option value="Sim">Sim</option><option value="Não">Não</option></select></div></div>');
    ...
    $('#hr_entrega, .extra-fields *, #formularioObservacoes_2').change(function(){
        theme.functions.orderDetailsUpdate();
    });
	...
	minDate: 0,
		...
		validDate.setDate(validDate.getDate() - window.REMOVE_DIAS);    
            ...
            zip = zip && zip.length >= 8 ? parseInt(zip.replace('-','')) : false;
        ...
        onSelect: function(dateText, dateObj){
            ...
            console.log(day);
            if(!rules){
                rules = schedule_config.find(el => el.weekday.includes(day) && el.range.min <= zip &&  el.range.max >= zip);
            }
...
theme.functions.init = function(){
    ...
    theme.icon.search = '<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M29.3636 30.6364C29.7151 30.9879 30.2849 30.9879 30.6364 30.6364C30.9879 30.2849 30.9879 29.7151 30.6364 29.3636L29.3636 30.6364ZM26.1 15.75C26.1 21.4661 21.4661 26.1 15.75 26.1V27.9C22.4603 27.9 27.9 22.4603 27.9 15.75H26.1ZM15.75 26.1C10.0339 26.1 5.4 21.4661 5.4 15.75H3.6C3.6 22.4603 9.03974 27.9 15.75 27.9V26.1ZM5.4 15.75C5.4 10.0339 10.0339 5.4 15.75 5.4V3.6C9.03974 3.6 3.6 9.03974 3.6 15.75H5.4ZM15.75 5.4C21.4661 5.4 26.1 10.0339 26.1 15.75H27.9C27.9 9.03974 22.4603 3.6 15.75 3.6V5.4ZM30.6364 29.3636L24.355 23.0822L23.0822 24.355L29.3636 30.6364L30.6364 29.3636Z" fill="black"/></svg>';
...
theme.functions['pagina-404'] = function(){
    $('#corpo').addClass('pagina-404');
    $('#corpo').prepend(`<div class="_404"><div class="content"><b>Opsss.... Desculpe!</b>Não encontramos a página que você está procurando.<br><a href="http://wa.me/'+ theme.worker.floatingWhatsapp.config.number+'">Clica aqui</a> e fale com a gente pelo whatsapp, vamos tentar resolver.<br><br>Ou dá uma olhadinha nos produtos abaixo, pode ter algo que você goste!</div><picture><source media="(max-width: 768px)" srcset="https://cdn.jsdelivr.net/gh/alpix-dev/li_frutifica/404_m.png"><source media="(min-width: 769px)" srcset="https://cdn.jsdelivr.net/gh/alpix-dev/li_frutifica/404.png"><img src="https://cdn.jsdelivr.net/gh/alpix-dev/li_frutifica/404.png" alt="404"></picture></div>`);
    $('#corpo .secao-principal').html('');
    $('.breadcrumbs').remove();
    $.get('/', function(data){
        $('<div id="listagemProdutos" class="listagem borda-alpha"></div>').appendTo('#corpo .secao-principal')
        $(data).find('.vitrine-mas-vendido').appendTo('#listagemProdutos')
        
        $(data).find('.vitrine-mas-vendido + ul').appendTo('#listagemProdutos');
        theme.functions.productListActions();
        theme.functions.unwrapProductList();
        theme.functions.flags();    
        theme.functions.productListImageSize(theme.settings.imageSize);
...
theme.functions['pagina-categoria'] = function(){
    ...
    let listing = $('<span>Página <span class="selectorContainer"></span> de '+ lastPage + '. Exibindo <span class="product__count">' + $('.listagem-item').length  + '</span> produtos.</span>');
    ...
    if($('#theme_filter li.active').length > 0){
        ...
        if(window.location.search.includes('&q=') || window.location.search.includes('et=')){
        ...
        }else if(window.location.search.includes('?q=') || window.location.search.includes('et=')){
            $('<a id="theme_filter-clean" href="'+ window.location.pathname + '?q='+window.location.search.split('?q=')[1]+'"><i class="icon-undo"></i>&nbsp;&nbsp;<span>Limpar Filtros</span></a>').prependTo('#theme_filter.theme_aside-content');
        }
        else{
...
theme.functions['pagina-produto'] = function(){
    ...
    if($('.thumbs-horizontal').length > 0){
        ...
        if($('.thumbs-horizontal img').length > theme.settings.sliders.horizontalProductGallery.slidesToShow){
            $('.thumbs-horizontal #carouselImagem .miniaturas').apx_slick(theme.settings.sliders.horizontalProductGallery);
            
        }else{
            $('.thumbs-horizontal').addClass('unslicked')
        }
    ...
    $( document ).on( "ajaxComplete", function( event, xhr, settings ) {
        if(settings.url.includes("compre_junto/")){
            
            setTimeout(() => {
                $('#buy-together-position1').insertBefore('[theme-content="produtos-relacionados"]');
                $('.compre-junto__imagem img').each(function(){
                    let src = $(this).attr('src').replace('150x150/','');
                    $(this).attr('src',src)
                });
                $('.compre-junto__preco-total').appendTo('.compre-junto__comprar button')
              }, "500");
...
$(window).load(function(){
        ...
        $('.listagem-item .produto-sku').each(function(){
            ...
            if(item){
                ...
                $.each(labels,function(k,id_){
                    ...
                    if(etiqueta){
                        etiqueta_box.append('<span data-filter="'+ etiqueta.id+'" style="'+ (etiqueta.cor_fundo ? 'background-color:' + etiqueta.cor_fundo + ';' : '') + (etiqueta.cor_texto ? 'color:' + etiqueta.cor_texto + ';' : '')   +'">'+ etiqueta.titulo +'</span>');
                    }
                });
            }
        })
    ...
    if($('.pagina-produto').length > 0 && db_produtos && db_etiquetas && db_ingredientes){
		...
		ingrediente_box.after('<div class="alerta_alergicos"><p style="color: #a7a9ac; font-family: Helvetica !important;"><img src="https://cdn.awsli.com.br/568/568718/arquivos/alerta.png" ><strong style="padding-left: 10px;">ALÉRGICOS:</strong> Pode conter Trigo e Derivados, Aveia, Centeio, Cevada, Ovos, Soja, Leite e Latex.</p></div>');
            }
            ...
            if($('[theme-content="tabela-nutricional"] *').length > 0){
                ...
                tabela_box.prepend('<div class="f_tabela-nutricional-expert"><span>Consulte quanto este prato representa na sua dieta de <input type="text" value="2000"/> kcal por dia</span> <button type="button"><img src="https://cdn.awsli.com.br/2517/2517596/arquivos/gym.svg"/><span>Editar macros</span></button></div>');
