        ...
        $('#f_entrega-modal form').submit(function(e){
            ...
            $.get('/carrinho/frete?cep='+ apx_zip +'&produto_id=194547534&quantidade=1', function(data, status){
                ...
                if(dt.length > 0){
                    ...
                    $('#f_entrega-modal-result').html('<span class="err">Pedimos desculpas, mas no momento ainda não realizamos entregas na sua região. Estamos empenhados em expandir nossa cobertura e em breve estaremos levando todo o nosso sabor até a sua casa. Enquanto isso, você pode entrar em contato conosco através do nosso WhatsApp para agendar a retirada dos seus pedidos em nossa loja física.</span>');
                }
